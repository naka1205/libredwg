  ...
  return (async function(moduleArg = {}) {
    ...
    if (ENVIRONMENT_IS_NODE) {
      ...
      if (!(typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('index.cjs', document.baseURI).href)).startsWith("data:")) {
        scriptDirectory = nodePath.dirname(require2("url").fileURLToPath((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('index.cjs', document.baseURI).href)))) + "/";
      }
      readBinary = (filename) => {
    ...
    function findWasmBinary() {
      ...
      return new URL("libredwg-web.wasm", (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('index.cjs', document.baseURI).href))).href;
    }
...
exports.DwgAttachmentPoint = DwgAttachmentPoint;
exports.DwgBoundaryPathEdgeType = DwgBoundaryPathEdgeType;
exports.DwgBoundaryPathTypeFlag = DwgBoundaryPathTypeFlag;
exports.DwgCodePage = DwgCodePage;
exports.DwgDimensionTextHorizontal = DwgDimensionTextHorizontal;
exports.DwgDimensionTextLineSpacing = DwgDimensionTextLineSpacing;
exports.DwgDimensionTextVertical = DwgDimensionTextVertical;
exports.DwgDimensionToleranceTextVertical = DwgDimensionToleranceTextVertical;
exports.DwgDimensionType = DwgDimensionType;
exports.DwgDimensionZeroSuppression = DwgDimensionZeroSuppression;
exports.DwgDimensionZeroSuppressionAngular = DwgDimensionZeroSuppressionAngular;
exports.DwgHatchAssociativity = DwgHatchAssociativity;
exports.DwgHatchBoundaryAnnotation = DwgHatchBoundaryAnnotation;
exports.DwgHatchGradientColorFlag = DwgHatchGradientColorFlag;
exports.DwgHatchGradientFlag = DwgHatchGradientFlag;
exports.DwgHatchPatternType = DwgHatchPatternType;
exports.DwgHatchSolidFill = DwgHatchSolidFill;
exports.DwgHatchStyle = DwgHatchStyle;
exports.DwgPolylineFlag = DwgPolylineFlag;
exports.DwgSmoothType = DwgSmoothType;
exports.DwgTextGenerationFlag = DwgTextGenerationFlag;
exports.DwgTextHorizontalAlign = DwgTextHorizontalAlign;
exports.DwgTextVerticalAlign = DwgTextVerticalAlign;
exports.DwgThumbnailImageType = DwgThumbnailImageType;
exports.Dwg_File_Type = Dwg_File_Type;
exports.Dwg_Hatch_Edge_Type = Dwg_Hatch_Edge_Type;
exports.Dwg_Object_Supertype = Dwg_Object_Supertype;
exports.Dwg_Object_Type = Dwg_Object_Type;
exports.Dwg_Object_Type_Inverted = Dwg_Object_Type_Inverted;
exports.HEADER_VARIABLES = HEADER_VARIABLES;
exports.LibreDwg = LibreDwg;
exports.createModule = libredwg_web_default;
exports.dwgCodePageToEncoding = dwgCodePageToEncoding;
exports.dwgVersions = dwgVersions;
exports.isModelSpace = isModelSpace;
exports.isPaperSpace = isPaperSpace;
